    ...
    <>
      <div className='min-h-full'>
        ...
        <div className='py-10'>
          ...
          <main className=''>
            <div className='mx-auto grid grid-cols-3 grid-flow-col max-w-7xl sm:px-6 lg:px-8 grid grid-cols-12 gap-4 '>
              <Categories
                categories={categories}
                onFilterChange={handleFilterChange}
                onCategoryChange={handleCategoryChange}
                className='bg-white min-h-4 col-span-3 category-sidebar'
              />
              <AllStores
                onFilterChange={handleFilterChange}
                ...
                className=' ml-4 col-span-2 min-h-4 col-span-9'
              />
            </div>
          </main>
        </div>
